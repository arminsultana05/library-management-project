...
import img from "../../assets/images/animation_500_l6988a4t.gif"
...
const Contact = () => {
    ...
    return (
        ...
        <section className="mid-container" id='contact'>
               <h1 className='text-4xl font-bold border-b-[1px] pb-3 mb-5'>Contact Us</h1>
            ...
            <div className="flex md:flex-nowrap flex-wrap lg:mt-12 mb-5">
                ...
                <div className=" py-10 px-8 lg:w-2/4 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8  md:mt-0 border border-gray-300 rounded-lg shadow-2xl">
                    ...
                    <form ref={form} onSubmit={sendEmail} >
                        ...
                        <input className="text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none w-full rounded" type="submit" value="Send Message" />
