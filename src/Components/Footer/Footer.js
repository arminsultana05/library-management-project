...
const Footer = () => {
    ...
    return (
        ...
        <div className="container mx-auto">
           <div className = "grid lg:grid-cols-4 md:grid-cols-1 gap-4 mb-11">
            ...
            <img className='h-20 w-60 mb-10' src={img3} alt="" />
             ...
             <div className="footerBorder ml-20">
               <div className="">
               <h1 className="text-2xl font-medium pb-5">Library</h1>
                 <h1 className="t font-medium pb-5">About us</h1>
                 <h1 className=" font-medium pb-5">All books</h1>
                 <h1 className=" font-medium pb-5">Gellery</h1>
                 <h1 className=" font-medium pb-5">Review</h1>
                 <h1 className="t font-medium pb-5">Contact Us</h1>
               </div>
             </div>
             <div>
             <h1 className=" text-2xl font-medium pb-5">Recent Book</h1>
           ...
           <hr></hr>
           <div>
             <h1 className='text-center pt-6 '>&copy;<span className="text-amber-400"> copyright</span> Library Management System /<span className="text-amber-400"> {year}</span></h1>
           </div>
        </div>
